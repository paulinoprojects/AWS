...
- Object locking:
  ...
  - Can ONLY be set up during the creation of the bucket. 
  - Needs bucket versioning enabled

- Batch processing (batch operations):
  - Batch operations create jobs to enableautomatic actions 
  - Use CSV or JSON file to run against batch process

- Intelligent tiering:
  - Automates sotrage class transitions
  - Example, objects after 90 days will transition to deep archive such as Glacier. 
  - Use lifecycle rules to implement intelligent tiering. 
